...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`animate__animated animate__fadeInDown transition-all bg-gray-100 lg:fixed sticky top-0 left-0 w-full flex items-center justify-center z-10 dark:bg-slate-800 ${windowScroll
