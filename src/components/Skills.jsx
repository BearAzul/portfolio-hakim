...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      className="scroll-section transition-all bg-gray-100 dark:bg-slate-800 flex items-center justify-center min-h-auto py-20 w-full overflow-hidden"
    >
      <div className="container mx-auto space-y-10 md:max-w-2xl lg:max-w-5xl relative">
