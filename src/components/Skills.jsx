...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      className="scroll-section transition-all bg-gray-100 dark:bg-slate-800 flex items-center justify-center lg:min-h-screen min-h-auto pt-20 w-full overflow-hidden"
    >
