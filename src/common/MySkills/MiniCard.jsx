...
const MiniCard = ({ skill }) => {
  return (
    <div className="flex items-center gap-3 px-2 py-3 transition duration-300 border border-gray-400 rounded-lg shadow md:px-5 hover:bg-slate-900 hover:border-teal-600 hover:text-white">
