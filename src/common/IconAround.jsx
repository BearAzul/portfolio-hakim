...
const IconSkills = () => {
  return (
    <>
      <div className="absolute w-[40px] lg:w-[50px] top-0 lg:-top-[65px] left-1/2 lg:-translate-x-[50px] -translate-x-[120px]">
        <img
      ...
      <div className="absolute w-[40px] lg:w-[50px] top-[30px] right-1/2 lg:translate-x-[195px] translate-x-[136px]">
        <img
      ...
      <div className="absolute w-[40px] lg:w-[60px] bottom-1/2 left-1/2 -translate-x-[130px] lg:-translate-x-[165px] lg:translate-y-[160px] translate-y-[80px]">
        <img
