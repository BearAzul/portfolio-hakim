...
export const CardRight = ({ title, element, address, years, category }) => {
  return (
    <div className="flex items-start justify-center gap-4 text-slate-800! mb-4">
...
export const CardLeft = ({ title, element, address, years, category }) => {
  return (
    <div className="flex items-start justify-center md:flex-row-reverse  gap-4 text-slate-800! mb-4">
